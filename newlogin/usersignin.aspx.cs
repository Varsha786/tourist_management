...
public partial class usersignin : System.Web.UI.Page
{
    ...
    protected void register(object sender, EventArgs e)
    {
        ...
        con.Open();
        string checkuser = "select email from usern where email='"+ email.Text+"' ";
        ...
        {
            sdr.Close();
            Int64 pno = Convert.ToInt64(moblie.Text);
            string insertqurey = "insert into usern (email,password,name,mobile) values(' " + email.Text + "','" + password.Text + "','" + name.Text + "'," + pno + ")";
